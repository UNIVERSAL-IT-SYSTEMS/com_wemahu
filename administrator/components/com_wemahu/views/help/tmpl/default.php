...
<div id="j-main-container" class="<?php echo $mainSpan; ?>">
	...
	<p>
		Besides scanning your joomla directly from the adminpanel you can also setup a cronjob to perform regular scans.<br />
		In the component options you can select a ruleset to be used in this case. You can further define an email-address which will be used to receive the reports.<br />
		Please point your cronjob to the following path:
	</p>
	<pre>/path/to/joomla/administrator/components/com_wemahu/wemahu_cli.php</pre>
	<p>An example entry in your crontab file could look like this:</p>
	<pre>0 2 * * * php /var/www/joomla/administrator/components/com_wemahu/wemahu_cli.php</pre>
	...
	<pre>0 2 * * * php /var/www/joomla/administrator/components/com_wemahu/wemahu_cli.php --ruleset 2</pre>
