...
INSERT INTO `#__wm_rulesets` (`id`, `name`, `filecheck`, `scandir`, `regex_check`, `regex_db`, `hash_check`, `hash_check_blacklist`, `filetypes`, `filesize_max`, `created`) VALUES
(1, 'default', 1, '', 1, 'regex_complete', 1, 'cache', 'php,php4,php5,jpg,png,gif,js,html,htm,xml,htaccess', 500000, '2014-02-22 13:27:42');